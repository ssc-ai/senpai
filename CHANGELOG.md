...
Upstreams the E-O Solutions MDP-validated detection/WCS engine onto the open-source base while
...
- Core registration flow (sidereal solve → shift chain → refinement → detection) is now the EOS
...
- Metrics-identical to the EOS reference on the 134-collect MDP benchmark (true positives 1061,
