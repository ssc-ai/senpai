"""Observability post-stage for per-night calibration products.

Aggregates per-frame photometry summaries from a night's batches into per-night
calibration products (zero point, extinction, limiting magnitude, Az/Alt
coverage).
