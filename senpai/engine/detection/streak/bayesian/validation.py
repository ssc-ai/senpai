...
def validate_proposed_shift(
    ...
    for y, x, _ in star_positions:  # Note: x and y are flipped here
        ...
        if (
            ...
            source_box = source_frame[y_int - half_box : y_int + half_box + 1, x_int - half_box : x_int + half_box + 1]
...
def extract_box_statistics(
    ...
    Args:
        ...
        x: Column coordinate of the box center
        y: Row coordinate of the box center
...
def quick_correlation_from_boxes(
    ...
    Args:
        target_frame: Target frame data
        source_frame: Source frame data
        shift_x: Shift in x to apply to source positions
        shift_y: Shift in y to apply to source positions
...
def validate_proposed_shift_v26(
    target: RateTrackFrame | SiderealFrame,
    source: RateTrackFrame | SiderealFrame,
    shift_x: float,
    shift_y: float,
