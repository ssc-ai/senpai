...
# the senpai.settings facade, and the fields added by the EOS engine port.
# --------------------------------------------------------------------------- #
...
def test_new_astrometry_fields_default() -> None:
    """The EOS-port astrometry fields carry their expected defaults."""
    c = AppConfig(**_min_app())
...
def test_new_detection_fields_default() -> None:
    """The EOS-port detection fields carry their expected defaults."""
    d = DetectionConfig()
